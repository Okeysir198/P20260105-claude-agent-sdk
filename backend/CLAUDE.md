...
- **Media tools primary engines** — Whisper V3 Turbo (STT, 99 languages, auto-detect), Chatterbox Turbo (TTS primary, voice cloning with 8 built-in voices + reference audio), Supertonic v1_1 (TTS, 21 voices), Kokoro (TTS, lightweight multi-language).
